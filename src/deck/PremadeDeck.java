...
public class PremadeDeck
{
	...
	{ mage, mage, mage, mage, knight, knight, knight, knight, dragon, dragon, dragon, dragon, sword, sword, sword,
			shield, shield, shield, armor, armor, armor, longSword, longSword, longSword, longSword, largeShield,
			largeShield, largeShield, largeShield, largeArmor, largeArmor, largeArmor, largeArmor };

	static Card[] darkMag =
	{ darkMagician, darkMagician, darkMagician, darkMagician, darkMagicianGirl, darkMagicianGirl, darkMagicianGirl,
			darkMagicianGirl, mage, mage, mage, mage, lightmage, lightmage, lightmage, lightmage, darkmage, darkmage,
			darkmage, darkmage, sword, sword, sword, shield, shield, shield, armor, armor, armor, longSword, longSword,
			longSword, longSword, lightSword, lightSword, lightSword, lightSword, darkSword, darkSword, darkSword,
			darkSword };
	static Card[] blastBlade =
	{ blasterBlade, blasterBlade, blasterBlade, blasterBlade, alfred, alfred, alfred, alfred, knight, knight, knight,
			knight, warrior, warrior, warrior, warrior, swordsman, swordsman, swordsman, swordsman, sword, sword, sword,
			shield, shield, shield, armor, armor, armor, largeShield, largeShield, largeShield, largeShield,
			lightShield, lightShield, lightShield, lightShield, darkShield, darkShield, darkShield, darkShield };
	static Card[] desDragon =
	{ drgOfDestiny, drgOfDestiny, drgOfDestiny, drgOfDestiny, aquaSurfer, aquaSurfer, aquaSurfer, aquaSurfer, dragon,
			dragon, dragon, dragon, beast, beast, beast, beast, monster, monster, monster, monster, sword, sword, sword,
			shield, shield, shield, armor, armor, armor, largeArmor, largeArmor, largeArmor, largeArmor, lightArmor,
			lightArmor, lightArmor, lightArmor, darkArmor, darkArmor, darkArmor, darkArmor };
	static Card[] exodiaD =
	{ exodia, exodiaLArm, exodiaRArm, exodiaLLeg, exodiaRLeg, exodia, exodiaLArm, exodiaRArm, exodiaLLeg, exodiaRLeg,
			exodia, exodiaLArm, exodiaRArm, exodiaLLeg, exodiaRLeg, exodia, exodiaLArm, exodiaRArm, exodiaLLeg,
			exodiaRLeg };
	...
	{ defaultDeck, darkMagDeck, blastBladeDeck, desDragonDeck, exodiaDeck };
}
